                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea name="description" class="form-control form-control-line" id=""></textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea name="content" class="form-control form-control-line" id="content"></textarea>
                                    @error('content')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
