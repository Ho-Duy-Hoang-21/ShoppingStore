                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30">
                                    <img src="{{ Auth::guard('admin')->user()->avatar
                                        ? asset('admin/upload/avatar/' . Auth::guard('admin')->user()->avatar)
                                        : asset('admin/assets/images/users/5.jpg') }}"
                                        class="rounded-circle" width="150" height="150" style="object-fit: cover;" />
                                    <h4 class="card-title m-t-10">{{ Auth::guard('admin')->user()->name }}</h4>
                            ...
                            <div class="card-body"> <small class="text-muted">Email address </small>
                                <h6>{{ Auth::guard('admin')->user()->email }}</h6> <small
                                    class="text-muted p-t-30 db">Phone</small>
                                <h6>{{ Auth::guard('admin')->user()->phone }}</h6> <small
                                    class="text-muted p-t-30 db">Address</small>
                                <h6>{{ Auth::guard('admin')->user()->address }}</h6>
                                <div class="map-box">
                                    <iframe
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" enctype="multipart/form-data"
                                    action="{{ route('page-profile.update') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="phone" value="{{ Auth::guard('admin')->user()->phone }}"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="address" value="{{ Auth::guard('admin')->user()->address }}"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <select class="form-control form-control-line" name="id_country">
                                                ...
                                                @foreach ($countries as $country)
                                                    <option value="{{ $country->id }}"
                                                        {{ Auth::guard('admin')->user()->id_country == $country->id ? 'selected' : '' }}>
                                                        {{ $country->name }}
                                                    </option>
                                                @endforeach
                                            </select>
