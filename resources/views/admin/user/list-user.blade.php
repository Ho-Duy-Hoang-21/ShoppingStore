                            ...
                            <tbody>
                                @foreach ($user as $key)
                                    <tr>
                                        ...
                                        <td class="text-start">{{ $key->address }}</td>
                                        <td class="text-start">{{ $levels[$key->level]}}</td>
                                        <td>
                                            <a href="{{ route('edit.list-user', $key->id) }}" class="btn btn-warning btn-sm">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-danger btn-sm"
                                                onclick="confirmDelete('{{ route('delete.list-user', $key->id) }}', '{{ $key->name }}')">
