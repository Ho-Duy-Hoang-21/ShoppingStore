...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%23F59E0B'><path d='M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z'/><line x1='3' y1='6' x2='21' y2='6' stroke='%23F59E0B'/><path d='M16 10a4 4 0 01-8 0' stroke='white' fill='none'/></svg>">
...
<body>
    ...
    @if (View::hasSection('slide'))
        @include('frontend.layouts.silde')
    @endif

    @if (View::hasSection('leftside'))
